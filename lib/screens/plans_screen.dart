        ...
        : ListView(
            ...
            children: [
              Container(
                ...
                child: const Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 8),
                    Text(
                      'No ads, higher quality and offline playback across your devices.',
                      style: TextStyle(color: PlayTvColors.muted, height: 1.4),
                    ),
                  ],
                ),
              ),
              ...
              for (final p in plans)
                _PlanCard(plan: Map<String, dynamic>.from(p as Map)),
            ],
          ),
  );
}
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  '${plan['description'] ?? 'Premium PlayTv access'}',
                  style: const TextStyle(
            ...
            children: [
              ...
              FilledButton(
                onPressed: () => ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                    content: Text(
                      'Checkout will be connected to the payment provider.',
                    ),
                  ),
                ),
