...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void open(PlayTitle t) => Navigator.of(context).push(
    MaterialPageRoute(
              ...
              delegate: SliverChildListDelegate([
                _Hero(
                  items: featured.isNotEmpty
                      ? featured
                      : (trending.isNotEmpty ? trending : movies),
                  onTap: open,
                ),
                if (progress.isNotEmpty)
                  _Continue(
                    items: progress.where((e) => e.title != null).toList(),
                    onTap: (p) => open(p.title!),
                  ),
          ...
          Positioned(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  t.synopsis ?? 'Stream now on PlayTv.',
                  maxLines: 2,
                  overflow: TextOverflow.ellipsis,
                  style: const TextStyle(
