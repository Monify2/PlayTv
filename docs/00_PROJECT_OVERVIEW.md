...
## Development model
Gemini CLI operates locally in the repository. GitHub Actions provides reproducible analysis, tests, Android APK builds, and later release builds. Repository instructions live in `GEMINI.md`; detailed specifications live under `docs/`.
